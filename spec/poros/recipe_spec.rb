...
RSpec.describe Recipe do
  it 'exists with attributes' do
    recipe_data = { recipe: { uri: 'http://www.edamam.com/ontologies/edamam.owl#recipe_1cb0bfc335666ef2f1ff31f4ba7ed4a5',
                              label: 'Baked Italy',
                              image: 'https://edamam-product-images.s3.amazonaws.com/web-img/0d8/0d8f382870e658d838cb18c9587558ac.JPG',
                              source: 'Food52',
